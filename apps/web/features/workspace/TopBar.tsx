    ...
    <header className="flex h-14 shrink-0 items-center justify-between gap-1 border-b border-border bg-surface/95 px-2 backdrop-blur sm:px-5">
      ...
      <div className="flex items-center gap-1.5">
        <button
          ...
          className="flex h-8 items-center gap-2 rounded-md border border-border bg-surface px-2 text-sm text-muted hover:bg-surface-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus/60 sm:px-2.5"
        >
